                        ...
                        <div className="p-4 border-b border-gray-200">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:outline-none text-sm text-gray-800"
                                    value={searchTerm}
                                    ...
                                    <div className="flex items-end gap-3">
                                        <div className="flex-1">
                                            <textarea
                                                ...
                                                className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 focus:outline-none resize-none"
                                                value={messageText}
